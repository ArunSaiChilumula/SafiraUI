            ...
            <div className="Courousal">
                <div>
                    <div className="image-hover-wrapper">
                        <img src="/images/product1.jpg" alt="vegetables" className="base-img" />
                        <img src="/images/product15.jpg" alt="hover vegetables" className="hover-img" />
                    </div>
                ...
                <div>
                    <div className="image-hover-wrapper">
                        <img src="/images/product3.jpg" alt="vegetables" className="base-img" />
                        <img src="/images/product6.jpg" alt="hover vegetables" className="hover-img" />
                    </div>
                ...
                <div>
                    <div className="image-hover-wrapper">
                        <img src="/images/product5.jpg" alt="vegetables" className="base-img" />
                        <img src="/images/product11.jpg" alt="hover vegetables" className="hover-img" />
                    </div>
                ...
                <div>
                    <div className="image-hover-wrapper">
                        <img src="/images/product7.jpg" alt="vegetables" className="base-img" />
                        <img src="/images/product13.jpg" alt="hover vegetables" className="hover-img" />
                    </div>
                ...
                <div>
                    <div className="image-hover-wrapper">
                        <img src="/images/product9.jpg" alt="vegetables" className="base-img" />
                        <img src="/images/product12.jpg" alt="hover vegetables" className="hover-img" />
                    </div>
